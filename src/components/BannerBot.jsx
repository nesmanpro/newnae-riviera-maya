...
export const BannerBot = () => {
    return (
        <section className='grid grid-cols-2 items-center h-80 overflow-hidden text-2xl text-azulOscuro bg-arenaOscuro rounded-tr-3xl rounded-tl-3xl'>
            ...
            <div className='p-10'>
                ...
                <div className='pt-5'>
                    <Link
                        to="/contact"
                        className="rounded-full bg-azulOscuro px-6 py-2.5 text-sm font-semibold text-arenaOscuro border-2 border-azulOscuro hover:text-azulOscuro shadow-sm hover:bg-transparent transition hover:duration-500 ease-in-out"
                    >
                        Contactanos
                    </Link>
                </div>
