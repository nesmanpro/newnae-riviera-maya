                ...
                <section className="overflow-hidden grid grid-cols-2 justify-center items-center rounded-3xl lg:max-w-4xl bg-[#023047] h-72">
                    ...
                    <div className='md:px-16 px-6 pb-2'>
                        ...
                        <div className="flex flex-col ">
                            <h1 className="text-2xl sm:text-3xl text-[#FFF8EA] leading-none tracking-wide  xs:text-2xl md:text-3xl lg:text-5xl mb-2"> ¿Cómo hacer una reserva?</h1>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <Link className=' flex justify-center w-16 my-3 bg-[#FFF8EA] text-[#023047] px-6 py-1 sm:px-12 sm:py-2 rounded-full cursor-pointer' to={'https://api.whatsapp.com/send?phone=5219842323621'} target="_blank">
                                <div>
